...
static void publish_brake_report( void )
{
    ...
    brake_report.data.dtc00_invalid_sensor_value = (uint8_t) g_brake_control_state.invalid_sensor_value;
    brake_report.data.dtc01_obd_timeout = (uint8_t) g_brake_control_state.obd_timeout;
    brake_report.data.dtc02_startup_pressure_check_error = (uint8_t) g_brake_control_state.startup_pressure_check_error;
    brake_report.data.dtc03_startup_pump_motor_check_error = (uint8_t) g_brake_control_state.startup_pump_motor_check_error;
