...
elseif(KIA_SOUL)
  ...
  message(WARNING "KIA_SOUL is being deprecated for VEHICLE string assign '-DVEHICLE=kia_soul'")
elseif(KIA_SOUL_EV)
  add_definitions(-DKIA_SOUL_EV)
  set(VEHICLE kia_soul_ev)
  message(WARNING "KIA_SOUL_EV is being deprecated for VEHICLE string assign '-DVEHICLE=kia_soul_ev'")
elseif(KIA_NIRO)
  add_definitions(-DKIA_NIRO)
  set(VEHICLE kia_niro)
  message(WARNING "KIA_NIRO is being deprecated for VEHICLE string assign '-DVEHICLE=kia_niro'")
else()
