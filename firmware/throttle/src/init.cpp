...
void init_devices( void )
{
    ...
    pinMode( PIN_ACCELERATOR_POSITION_SENSOR_A, INPUT );
    pinMode( PIN_ACCELERATOR_POSITION_SENSOR_B, INPUT );
    pinMode( PIN_ACCELERATOR_POSITION_SPOOF_A, INPUT );
    pinMode( PIN_ACCELERATOR_POSITION_SPOOF_B, INPUT );
