...
fn main() {
    ...
    let _ = bindgen::builder()
        ...
        .whitelisted_var("BRAKE_SPOOF_B_SIGNAL_RANGE_MIN")
        .whitelisted_var("BRAKE_SPOOF_B_SIGNAL_RANGE_MAX")
        .whitelisted_var("BRAKE_SPOOF_A_SIGNAL_RANGE_MIN")
        .whitelisted_var("BRAKE_SPOOF_A_SIGNAL_RANGE_MAX")
