...
fn main() {
    gcc::Build::new()
        ...
        .file("../../../common/testing/mocks/oscc_eeprom.cpp")
    ...
    let _ = bindgen::builder()
        ...
        .whitelisted_function("init_config")
        ...
        .whitelisted_var("STEERING_TORQUE_DIFFERENCE_OVERRIDE_THRESHOLD")
