...
fn main() {
    ...
    let _ = bindgen::builder()
        ...
        .whitelisted_var("PIN_TORQUE_SENSOR_A")
        .whitelisted_var("PIN_TORQUE_SENSOR_B")
        .whitelisted_var("TORQUE_DIFFERENCE_OVERRIDE_THRESHOLD")
        .whitelisted_var("STEERING_SPOOF_B_SIGNAL_RANGE_MIN")
        .whitelisted_var("STEERING_SPOOF_B_SIGNAL_RANGE_MAX")
        .whitelisted_var("STEERING_SPOOF_A_SIGNAL_RANGE_MIN")
        .whitelisted_var("STEERING_SPOOF_A_SIGNAL_RANGE_MAX")
