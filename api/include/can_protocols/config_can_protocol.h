/**
 * @file config_can_protocol.h
 * @brief Config CAN Protocol.
 *
 */


#ifndef _OSCC_OSCC_CONFIG_CAN_PROTOCOL_H_
#define _OSCC_OSCC_CONFIG_CAN_PROTOCOL_H_
 ...
 *
 */
#define OSCC_CONFIG_U8_CAN_ID (0x80)

/*
 * @brief U16 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_U16_CAN_ID (0x81)

/*
 * @brief U16 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_U32_CAN_ID (0x82)

/*
 * @brief I8 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_I8_CAN_ID (0x83)

/*
 * @brief I16 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_I16_CAN_ID (0x84)

/*
 * @brief I32 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_I32_CAN_ID (0x85)

/*
 * @brief F32 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_F32_CAN_ID (0x86)
...
#endif /* _OSCC_OSCC_CONFIG_CAN_PROTOCOL_H_ */
