 ...
 *
 */
#define OSCC_CONFIG_U8_CAN_ID (0xA0)

/*
 * @brief U16 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_U16_CAN_ID (0xA1)

/*
 * @brief U16 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_U32_CAN_ID (0xA2)

/*
 * @brief I8 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_I8_CAN_ID (0xA3)

/*
 * @brief I16 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_I16_CAN_ID (0xA4)

/*
 * @brief I32 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_I32_CAN_ID (0xA5)

/*
 * @brief F32 configuration message CAN ID.
 *
 */
#define OSCC_CONFIG_F32_CAN_ID (0xA6)
