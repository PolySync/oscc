...
static oscc_result_t oscc_enable_brakes();
static oscc_result_t oscc_enable_throttle();
static oscc_result_t oscc_enable_steering();
static oscc_result_t oscc_disable_brakes();
